...
- Pass `--cwd` to always import a copy of the session into the current directory, even if it belongs to the current folder's project (instead of resuming it in place).
